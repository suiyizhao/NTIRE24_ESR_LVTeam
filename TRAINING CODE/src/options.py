...
class TrainOptions():
    def __init__(self):
        ...
        self.parser.add_argument("--num_workers", type=int, default=34, help="number of cpu threads to use during batch generation")
        ...
        self.parser.add_argument("--middle_blk_num", type=int, default=3, help="number of the middle blocks between last downsample and first upsample")
        self.parser.add_argument("--enc_blk_nums", type=int, nargs='+', default=[1], help="number of the blocks in encoder of each scale")
        self.parser.add_argument("--dec_blk_nums", type=int, nargs='+', default=[1], help="number of the blocks in decoder of each scale")
        ...
        # ---------------------------------------- step 5/5 : training... ------------------------------------------------
        self.parser.add_argument("--print_gap", type=int, default=200, help="the gap between two print operations, in iteration")
