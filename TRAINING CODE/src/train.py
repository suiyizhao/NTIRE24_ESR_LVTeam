...
from models import LightRLFN, LightRLFNLocal
from utils import *
...
# model_val = AsyNAFLocal(img_channel=3, 
#                width=opt.width, 
#                middle_blk_num=opt.middle_blk_num, 
#                enc_blk_nums=opt.enc_blk_nums, 
#                dec_blk_nums=opt.dec_blk_nums,
...
model = LightRLFN().cuda()
model_val = LightRLFNLocal(train_size=(1, 3, opt.crop, opt.crop)).cuda()
